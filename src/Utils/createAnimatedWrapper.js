...
const getDebugBorder = (/* color: string = '#fff' */) => ({ borderWidth: 0 }); // { borderWidth: 1, borderColor: '#fff' }
...
const createAnimatedWrapper = (params: Parameters) => {
  ...
  const finalNativeAnimatedStyles =
    getResolvedRotation([...getStylesWithMergedTransforms([
  ...
  if (params.component.props.__index) { props = { ...props, index: parseInt(params.component.props.__index, 10) }; }
